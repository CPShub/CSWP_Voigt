function [deps0_di, dk0_di] = derivatives_vk(eps0, k0, i)
% Compute derivatives of eps0 and k0 for selection index i
% Input:
    % eps0          - (3,1) vector containing the strain prescriptors
    % k0            - (3,1) vector containing the twist prescriptors
    % i             - (1:6) selection index
% Output:
    % deps0_di      - (3,1) selection vector
    % dk0_di        - (3,1) selection vector
% ------------------------------------------------------------------------
