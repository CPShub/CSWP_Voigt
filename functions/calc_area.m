function [area] = calc_area(coords)
% Approximates the flat projected area spanned by the points in "coords"
% Input:
    % coords    - (n, 3) vector
% Output:
    % area      - (Float) area spanned by the points
% ------------------------------------------------------------------------
...
area = polyarea(coords(k, 1), coords(k, 2));
